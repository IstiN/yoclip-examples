...
project = {
  ...
  scenes: [
    ...
    { path: 'scenes/01b_prompt.scene.js', layer: 'content', start: 210 },
    { path: 'scenes/02_alive.scene.js', layer: 'content', start: 360 },
    { path: 'scenes/03_hardware.scene.js', layer: 'content', start: 540 },
    { path: 'scenes/04_core.scene.js', layer: 'content', start: 765 },
    { path: 'scenes/05_everywhere.scene.js', layer: 'content', start: 930 },
    { path: 'scenes/06_power.scene.js', layer: 'content', start: 1170 },
    { path: 'scenes/07_work.scene.js', layer: 'content', start: 1380 },
    { path: 'scenes/08_lockup.scene.js', layer: 'content', start: 1530 },
  ],
};
