// 05b — Brand splash re-run: the Fa trailer opening beat on white.
// Verbatim copy of 02b_brand (a scene file can only occupy one timeline
// slot — ids are derived from paths).
//
