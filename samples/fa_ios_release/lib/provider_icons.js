...
//
// Marks below the 'official marks' block come from Simple Icons
// (simpleicons.org) - real brand paths. The geometric ones after them
// stay as fallbacks / for providers without a published mark:
...
function providerIconSvg(name, color) {
  ...
  switch (name) {
    ...
    case 'claude':
      // Claude sunburst (official Simple Icons mark)
      return svg(
    ...
    case 'copilot':
      // GitHub Copilot (official Simple Icons mark)
      return svg(
    ...
    case 'minimax':
      // MiniMax (official Simple Icons mark)
      return svg(
    ...
    case 'anthropic':
      // Anthropic A (official Simple Icons mark)
      return svg(
