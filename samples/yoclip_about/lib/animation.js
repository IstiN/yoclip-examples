...
// ---- Motion sequences (jsr.motion, requires js_widget_runtime 0.4.114+) ----

/// Run a chain of tweened steps against the frame clock — the Motion-Canvas
/// style "one call sequences the whole build" helper.
///
...
///
/// Frames convert to elapsed ms internally (jsr.motion is ms-native), so
/// scenes keep thinking in frames. Pure: same frame → same values.
///
